  ...
  return (
    cartItems.length > 0 ?
      ...
      <ItemList cards={cartItems} cart />
       <div className="text-right font-semibold w-1/2 p-2 m-2">
        <h2>Total : { price}</h2>
      </div>
    </div> : <div className='flex text-lg text-red-600 font-semibold justify-center'>Looks empty here... Please add your favourite items to cart !</div>
  )
}
